...
export default function Hero() {
  return (
    <section id="home" className="relative min-h-[850px] md:h-screen flex items-center pt-32 pb-20 overflow-hidden">
      {/* Background Image */}
      <div className="absolute inset-0 z-0">
        <img
          src="/src/assets/images/hero_garden_1781348133574.jpg"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="max-w-3xl">
          ...
          >
            ...
            <h1 className="text-6xl md:text-8xl font-serif font-light text-white leading-[1.02] mb-10 italic drop-shadow-sm">
              Expert Landscaping <br className="hidden md:block" />
